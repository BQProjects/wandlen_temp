  ...
  <div className="flex-shrink-0 bg-[#ede4dc]">
    <div className="flex-shrink-0 py-20 pl-20 pr-20">
      <div className="inline-flex flex-col items-start gap-4">
        ...
        <div className=" w-[654px] text-[#381207] font-['Poppins'] text-5xl font-semibold leading-[136%]">
        ...
        <div className="flex flex-col items-start gap-6">
          <div className="flex flex-col items-start gap-4">
            <div className="flex flex-col items-start gap-5 pb-4">
              <div className="w-[424px] text-[#381207] text-justify font-['Poppins'] text-xl leading-[136%]">
                Virtual Walking opens the door to nature for everyone —
                regardless of physical limitations. Through authentic, real-life
                walking videos, we bring the beauty, peace, and familiarity of
                local landscapes to people who may no longer be able to
          ...
          <div className="flex items-center gap-2.5 py-2 px-5 rounded-lg bg-[#a6a643]  text-white font-['Poppins'] text-xl font-medium leading-[136%]">
            Start Your Journey
          </div>
        </div>
      </div>
