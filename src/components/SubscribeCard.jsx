...
<div className="flex justify-center items-center w-full py-16 bg-[#ede4dc]">
  <div className="flex items-start gap-16 p-12 max-w-[1200px] w-full rounded-3xl bg-white shadow-lg">
    <div className="flex flex-col items-start gap-8 flex-1">
      <h2 className="text-[#381207] font-['Poppins'] text-2xl font-semibold">Stay Inspired</h2>
      <div className="flex flex-col gap-6 w-full">
        {/* Email Address Field */}
        <div className="flex flex-col gap-2 w-full">
          <label className="text-[#381207] font-['Poppins'] text-lg font-medium tracking-[-0.18px]">Email address</label>
          <input 
            type="email" 
        ...
        <div className="flex gap-6 w-full">
          <div className="flex flex-col gap-2 flex-1">
            <label className="text-[#381207] font-['Poppins'] text-lg font-medium tracking-[-0.18px]">First name</label>
            <input 
              type="text" 
          ...
          <div className="flex flex-col gap-2 flex-1">
            <label className="text-[#381207] font-['Poppins'] text-lg font-medium tracking-[-0.18px]">Last name</label>
            <input 
              type="text" 
        ...
        {/* Notes Field */}
        <div className="flex flex-col gap-2 w-full">
          <label className="text-[#381207] font-['Poppins'] text-lg font-medium tracking-[-0.18px]">Notes</label>
          <textarea 
    ...
    {/* Image Section */}
    <div className="flex-shrink-0 w-[400px] h-[400px] rounded-2xl overflow-hidden">
      <img 
        src={HoldHands} 
