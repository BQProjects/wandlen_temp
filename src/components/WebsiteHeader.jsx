    ...
    <div className="flex justify-between items-center px-4 md:px-18 py-4 bg-secondary relative">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link
            to="/"
            className="flex justify-center items-center gap-2.5 body text-brown font-['Poppins'] text-xl font-medium leading-[136%] hover:text-dark-olive transition-colors"
          ...
          <Link
            to="/ourapproach"
            className="flex justify-center items-center gap-2.5 body-1 text-brown font-['Poppins'] text-xl font-medium leading-[136%] hover:text-dark-olive transition-colors"
          ...
          {isAuthenticated ? (
            <>
              <Link
                to={getDashboardLink()}
                className="flex justify-center items-center gap-2.5 text-brown font-['Poppins'] text-xl font-medium leading-[136%] hover:text-dark-olive transition-colors"
            ...
            <>
              <Link
                to="/become-volunteer"
                className="flex justify-center items-center gap-2.5 body-2 text-brown font-['Poppins'] text-xl font-medium leading-[136%] hover:text-dark-olive transition-colors"
              ...
              <Link
                to="/subscribe"
                className="flex justify-center items-center gap-2.5 body-3 text-brown font-['Poppins'] text-xl font-medium leading-[136%] hover:text-dark-olive transition-colors"
          ...
          <div className="flex justify-center items-center gap-2">
            ...
            <div className="body-5 text-muted font-['Poppins'] text-xl font-medium leading-[136%]">
              English
            </div>
            <svg
              width={24}
