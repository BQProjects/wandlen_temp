...
const HeartIcon = () => (
  <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 17.5L8.75 16.375C4.25 12.375 1.25 9.75 1.25 6.875C1.25 4.625 2.875 3 5.125 3C6.625 3 8.0625 3.8125 8.75 4.9375C9.4375 3.8125 10.875 3 12.375 3C14.625 3 16.25 4.625 16.25 6.875C16.25 9.75 13.25 12.375 8.75 16.375L10 17.5Z" fill="#381207" />
  </svg>
);
...
const VideoCard = ({
  ...
  <div className="bg-[#e6d9cd] rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer group max-w-sm">
