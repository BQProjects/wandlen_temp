    ...
    <>
      ...
      <div className="second-hero-container">
        ...
        <div className="main-description">
          Stel je voor: een boswandeling, het ritselen van bladeren en fluitende
          vogels. Voor mensen met dementie kan zo'n natuurbeleving veel
          betekenen. Virtueel Wandelen brengt deze ervaring dichtbij, gewoon
          vanuit huis of een zorginstelling. Het biedt rust, ontspanning en
          herkenning
        </div>
      ...
      <div className="flex-shrink-0 w-full min-h-[941px] bg-[#eeebc6] flex flex-col items-center justify-center py-16 px-8">
        <div className="w-full max-w-[1280px] mx-auto text-center">
          ...
          <div className="mb-16">
            <div
              className="text-[#5b6502] font-['Poppins'] text-4xl lg:text-5xl font-semibold leading-[136%] mb-4"
              style={{ letterSpacing: "-0.32px" }}
            >
              Discover Nature Videos
            </div>
            <div
              className="text-[#381207] font-['Poppins'] text-2xl lg:text-4xl font-semibold leading-[136%]"
          ...
          <div className="flex items-start justify-between gap-8 min-h-[400px]">
            ...
            <div className="flex flex-col items-center gap-10 flex-1 text-center">
              <div className="flex flex-col items-center gap-2 w-full">
                <div
                  className="text-[#a6a643] font-['Poppins'] text-[2rem] font-semibold leading-[136%] w-full"
                  style={{ letterSpacing: "-0.32px" }}
                >
                  Positive Experiences
                </div>
                <div
                  className="text-[#381207] font-['Poppins'] text-4xl lg:text-5xl font-semibold leading-[136%] w-full"
                  style={{ letterSpacing: "-0.48px" }}
                >
              ...
              <div
                className="flex justify-center items-center gap-2 py-2 px-4 rounded-lg bg-[#a6a643] text-white font-['Poppins'] text-xl font-medium leading-[136%] cursor-pointer hover:bg-opacity-90 transition-all"
            ...
            <div className="flex flex-col gap-4 flex-shrink-0">
              ...
              <div className="inline-flex flex-col justify-between items-start p-8 h-[328px] w-[303px] rounded-2xl bg-[#f7f6f4]">
                ...
                <div className="flex flex-col items-start gap-5 w-full">
                  ...
                  <div className="text-[#381207] font-['Poppins'] leading-[normal] w-full">
                    Residents enjoy spotting familiar scenes and telling
                    stories.
                  </div>
                </div>
              </div>
